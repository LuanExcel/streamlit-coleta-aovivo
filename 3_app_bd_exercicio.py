...
# Obter a instância do engine e criar a tabela se necessario
engine = try_connection()
if engine is not None:
    criar_tabela_se_nao_existir(engine)

# Configurar a sessão do SQLAlquemy
...
if submit_button:
    ...
    # Inserindo os dados no banco lendo esse json
    session = Session()
